...
import com.example.myapp.databinding.FragmentOilBinding
...
class oil : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button100.setOnClickListener {
            findNavController().navigate(R.id.action_oil_to_result39)
        }
        binding.button99.setOnClickListener {
            findNavController().navigate(R.id.action_oil_to_result40)
        }
    }
